...
class WizardTemplate extends CWizardTemplate
{
    function GetLayout()
    {
        ...
        $stepMainTitle = $stepTitle;
        if (strlen($stepSubTitle)) {
            $stepMainTitle = $stepSubTitle;
        }
        $BX_ROOT = BX_ROOT;
        $productVersion = "";
        ...
        if (isset($bxProductConfig["intranet_wizard"]["logo"])) {
            ...
            elseif (file_exists($_SERVER["DOCUMENT_ROOT"].$wizardPathCustom."/images/en/logo.png"))
                $logoImage = '<img src="'.$wizardPathCustom.'/images/en/logo.png" alt="" />';
        }
...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            body 
            {
                background: #0f2944;/*#781813 url({$wizardPath}/bg_fill.gif) repeat;*/
                margin:0;
                padding:0;
                padding-bottom:6px;
                ...
                <table width="100%" height="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="535" valign="top">
                            ...
                            <div id="step-title">{$stepMainTitle}</div>
                            {#FORM_START#}
                            <div id="step-content">
                                {$strError}
                                {#CONTENT#}
