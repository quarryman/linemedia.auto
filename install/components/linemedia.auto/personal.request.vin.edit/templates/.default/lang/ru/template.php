...
$MESS ['SUP_MESSAGE'] = "Описание детали";
$MESS ['SUP_B'] = "B";
...
$MESS ['SUP_STORE_EMPLOYEE'] = "сотрудник магазина";
$MESS ['SUP_AUTH_LIKE_UNREGISTER_USER'] = "Вы вошли как незарегистрированный пользователь. Ваша личная информация не собирается и удаляется после обработки данного запроса.";



$MESS ['VIN_CODE'] = "Код VIN";
$MESS ['MESSAGE'] = "Сообщение";
$MESS ['COMPLECTATION'] = "Особенности комплектации";
$MESS ['NAME'] = "Имя";
