...
$arParams['HIDE_PROPERTIES'] = (array) $arParams['HIDE_PROPERTIES'];
...
if($arOrder = $dbOrder->GetNext())
{
	...
	$dbBasket = CSaleBasket::GetList(
			...
			false,
			false,
			array("ID", "DETAIL_PAGE_URL", "NAME", "NOTES", "QUANTITY", "PRICE", "CURRENCY", "PRODUCT_ID", "DISCOUNT_PRICE", "WEIGHT", "CATALOG_XML_ID", "VAT_RATE", "PRODUCT_XML_ID")
		);
