...
$MESS ['LM_AUTO_MAIN_PROP_GROUP_PROFILE'] = "Поля для заполнения профиля";
$MESS ['LM_AUTO_MAIN_PROP_GROUP_SUBSCRIBE'] = "Подписка на рассылки";
$MESS ['LM_AUTO_MAIN_PROP_PERSON_TYPE_ID'] = "Тип плательщика";
$MESS ['LM_AUTO_MAIN_PROP_SUBSCRIBE_RUBRICS'] = "Рассылки для подписки";
$MESS ['LM_AUTO_MAIN_PROP_PERSON_SALE_PROFILE_FIELDS'] = "Поля профиля покупателя для заполнения";
$MESS ['LM_AUTO_MAIN_PROP_USE_EMAIL_AS_LOGIN'] = "Использовать e-mail как логин";
$MESS ['LM_AUTO_MAIN_PROP_GET_SUBSCRIBE'] = "Предлагать подписаться на рассылки сайта";
